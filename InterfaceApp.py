...
class InterfaceApp:
    ...
    def run_geo_checker(self):
        if self.check_folder:
            self.app.run_geo_checker(result_path=self.check_folder)
    ...
    def set_additional_paths(self, catchment_file: str, gw_file: str, ds_folder: str, check_result_folder: str):
        # set in app
        ...
        self.app.set_geo_check_results_folder(folder_path=check_result_folder)
        ...
        if _errors:
            ...
            self.check_folder = check_result_folder
